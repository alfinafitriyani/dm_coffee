...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-2 text-gray-800">Edit Makanan</h1>
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('admin.makanan.update', ['id' => $makanan->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('images/' . $makanan->gambar) }}" alt="{{ $makanan->nama }}" width="100">
                    </div>
                    <div class="form-group">
